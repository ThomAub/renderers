...
pub trait MediaResolver: Send + Sync + std::fmt::Debug {
    ...
    /// slot.
    fn resolve_image(&self, source: &MediaSource<'_>) -> Result<crate::types::MediaItem, RenderError>;
    ...
    fn resolve_video(&self, _source: &MediaSource<'_>) -> Result<crate::types::MediaItem, RenderError> {
